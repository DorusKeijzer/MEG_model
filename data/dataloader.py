...
class MEGVolumeDataset(Dataset):
    ...
    def __init__(self, root_dir, mode='train', task_group_choice="Intra"):
        self.samples = []
        if task_group_choice is "Both":
            task_group_choice = ["Intra", "Cross"]
        else:
            task_group_choice = [task_group_choice]
        
        for task_group in task_group_choice:
